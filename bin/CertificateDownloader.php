...
// load autoload.php
// plugins/WechatPayH5/bin
$possibleFiles = [__DIR__.'/../../../vendor/autoload.php'];
$file = null;
...
use Plugin\WechatPayH5\WeChatPayV3\ClientDecoratorInterface;
use Plugin\WechatPayH5\WeChatPayV3\Crypto\AesGcm;

 /**
  * CertificateDownloader class
  * php CertificateDownloader.php -f apiclient_key.pem -k 6009245f55b740c89e5e53bf42a6ec11 -m 1667347897 -s 2B5C3960E5B4BD59679D8B8EE9C17AD35F50F3A6 -o platformCert
  * 用这个命令得到平台公钥
  */
